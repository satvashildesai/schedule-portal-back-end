...
public class ErrorResponse {
	...
	public ErrorResponse(String statusCodeValue, String statusCode, String message) {
		super();
	...
	public ErrorResponse(String statusCodeValue, String statusCode, String message, List<Object> data) {
		super();
		this.statusCodeValue = statusCodeValue;
		this.statusCode = statusCode;
		this.message = message;
